...
bool initLibNvInferPlugins(void* logger, const char* libNamespace)
{
    ...
    initializePlugin<nvinfer1::plugin::VoxelGeneratorV1PluginCreator>(logger, libNamespace);
    initializePlugin<nvinfer1::plugin::DensePluginCreator>(logger, libNamespace);
