...
def make_cuda_ext(name, module, sources, extra_compile_args=None):
...
if __name__ == '__main__':
    ...
    setup(
        ...
        ext_modules=[
            ...
            make_cuda_ext(
                name='dense_cuda',
                module='pcdet.ops.dense',
                sources=[
                    'src/dense_api.cpp',
                    'src/cuda_scatter.cu',
                    'src/cuda_scatter_fp16.cu',
                ],
            ),
            make_cuda_ext(
                name='voxels_cuda',
                module='pcdet.ops.voxels',
                sources=[
